...
const CreateConfession = ({setCreate}) => {
    ...
    return (
        <>
            <div
                className=" max-w-[900px] w-full m-auto  flex flex-col gap-6 bg-gray-50 border border-blue-100 rounded p-3">
                ...
                <form onSubmit={handleSubmit}
                    ...
                    <textarea id="confession" placeholder="Your confession here." value={confession}
                              onChange={e => setConfession(e.target.value)} maxLength={3000}
